...
% java TwoWayMesgServer 50000 server

# Then, run the client program with the server's whereabouts
% java TwoWayMesgClient localhost 50000 client

# Type messages at the client and see them displayed at the server and vis versa
